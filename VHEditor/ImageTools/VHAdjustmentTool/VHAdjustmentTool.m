...
//
//
//  Created by Little Yoda on 28.11.15.
//  Copyright (c) 2015 Little Yoda. All rights reserved.
//

#import "VHAdjustmentTool.h"

@implementation VHAdjustmentTool {
...
+ (NSString *)defaultTitle {
    return NSLocalizedStringWithDefaultValue(@"VHAdjustmentTool_DefaultTitle", nil, [VHEditorTheme bundle], @"Adjustment", @"");
}
...
- (void)executeWithCompletionBlock:(void(^)(UIImage *image, NSError *error, NSDictionary *userInfo))completionBlock {
    dispatch_async(dispatch_get_main_queue(), ^{
        _indicatorView = [VHEditorTheme indicatorView];
...
- (void)setupSlider {
    ...
    [_saturationSlider setThumbImage:[VHEditorTheme imageNamed:[NSString stringWithFormat:@"%@/saturation.png", [self class]]] forState:UIControlStateNormal];
    [_saturationSlider setThumbImage:[VHEditorTheme imageNamed:[NSString stringWithFormat:@"%@/saturation.png", [self class]]] forState:UIControlStateHighlighted];
    ...
    [_brightnessSlider setThumbImage:[VHEditorTheme imageNamed:[NSString stringWithFormat:@"%@/brightness.png", [self class]]] forState:UIControlStateNormal];
    [_brightnessSlider setThumbImage:[VHEditorTheme imageNamed:[NSString stringWithFormat:@"%@/brightness.png", [self class]]] forState:UIControlStateHighlighted];
    ...
    [_contrastSlider setThumbImage:[VHEditorTheme imageNamed:[NSString stringWithFormat:@"%@/contrast.png", [self class]]] forState:UIControlStateNormal];
    [_contrastSlider setThumbImage:[VHEditorTheme imageNamed:[NSString stringWithFormat:@"%@/contrast.png", [self class]]] forState:UIControlStateHighlighted];
}
